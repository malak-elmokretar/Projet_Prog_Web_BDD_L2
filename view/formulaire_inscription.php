<div class="container mt-5 d-flex flex-column align-items-center text-center">
  ...
  <form action="<?php echo $action;?>" method="<?php echo $method;?>">
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control" id="nomUser" minlength="2" maxlength="50" required>
    </div>

    <div class="mb-3">
      <label for="prenomUser" class="form-label">Prénom :</label>
      <input type="text" class="form-control" id="prenomUser" minlength="2" maxlength="50" required>
    </div>
    ...
    <div class="mb-3">
      ...
      <div class="input-group">
        ...
        <input type="mail" class="form-control" id ="email" minlength="3" maxlength="50" required>
      </div>
    </div>
